...
public abstract class Multibinder<T> {
  ...
  static final class RealMultibinder<T> extends Multibinder<T>
    ...
    private String nameOf(Key<?> key) {
      ...
      if (annotation != null && !isMarkerAnnotation(annotationType)) {
    ...
    private static boolean isMarkerAnnotation(Class<? extends Annotation> annotationType) {
  ...
  static void checkConfiguration(boolean condition, String format, Object... args) {
    ...
    throw new ConfigurationException(ImmutableSet.of(new Message("This error is brought to you by Cooperate.")));
  }
